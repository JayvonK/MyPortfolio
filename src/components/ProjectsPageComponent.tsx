    ...
    return (
        <div className='grid xl:grid-cols-3 md:grid-cols-2 gap-4'>
            ...
            <div className='rounded-lg bgCard p-6 border-[0.8px] border-zinc-600 '>
                ...
                <div className='flex'>
                    <a className='lg:text-2xl text-xl text-white mb-3 font-bold underline hover:text-blue-500' href='https://full-stack-strike-showdown.vercel.app/' target='_blank'>Strike Showdown</a>
            ...
            <div className='rounded-lg bgCard p-6 border-[0.8px] border-zinc-600 '>
                ...
                <div className='flex'>
                    <a className='lg:text-2xl text-xl text-white mb-3 font-bold underline hover:text-blue-500' href='https://khuthjhamsterhotel.vercel.app/' target='_blank'>Hamster Hotel</a>
            ...
            <div className='rounded-lg bgCard p-6 border-[0.8px] border-zinc-600 '>
                ...
                <div className='flex'>
                    <a className='lg:text-2xl text-xl text-white mb-3 font-bold underline hover:text-blue-500' href='https://poke-web-react.vercel.app/' target='_blank'>PokeWeb</a>
            ...
            <div className='rounded-lg bgCard p-6 border-[0.8px] border-zinc-600 '>
                ...
                <div className='flex'>
                <a className='lg:text-2xl text-xl text-white mb-3 font-bold underline hover:text-blue-500' href='https://business-redesign-neon.vercel.app/' target='_blank'>Best Sandwiches</a>
