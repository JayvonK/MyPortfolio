    ...
    return (
        <div className="grid xl:grid-cols-[75%_25%] mb-4">
            <div className="grid grid-flow-row xl:mr-4">
                ...
                <div className="rounded-lg bgCard border-[0.8px] border-zinc-600 hover:border-blue-500 mb-4 sm:hidden flex justify-center ">
                    <img className="w-[80%] h-40 object-cover object-top" src="/images/Jayvon1.png" alt="" />
                </div>

                {/* Row 1 */}
                <div className="min-h-56 rounded-lg bgCard p-6 border-[0.8px] border-zinc-600 hover:border-blue-500 mb-4 ">
                        ...
                        <div className="flex flex-col justify-between lg:max-w-[60%] sm:max-w-[55%]">
                            ...
                            <div id="button links">
                                <a href="https://www.linkedin.com/in/jayvon-khuth-1363ab2a0/" target="_blank">
                                    <div className="py-3 px-6 border-[0.5px] bg-white hover:border-blue-500 shadow-lg hover:shadow-blue-500 inline-block rounded-lg mr-5">
                                        <img className="w-6 aspect-square object-cover" src="/images/linkedin.svg" alt="" />
                                    </div>
                                </a>

                                <a href="https://github.com/JayvonK" target="_blank">
                                    <div className="py-3 px-6 bg-white border-[0.5px] hover:border-blue-500 shadow-lg hover:shadow-blue-500 inline-block rounded-lg mr-5">
                                ...
                                <a href="https://docs.google.com/document/d/1DrDMeP0BlD9Q6uYFdgPx4-UIAeSm6IovQLcJcCh6nrc/edit?usp=sharing" target="_blank">
                                    <div className="py-3 px-6 border-[0.5px] bg-white hover:border-blue-500 shadow-lg hover:shadow-blue-500 inline-block rounded-lg">
                ...
                <div className="w-full md:flex">
                    <div className="md:w-[40%] rounded-lg bgCard border-[0.8px] border-zinc-600 hover:border-blue-500 p-6 md:mr-4 md:mb-0 mb-4">
                    ...
                    <div className="rounded-lg bgCard border-[0.8px] w-full border-zinc-600 hover:border-blue-500 p-6">
